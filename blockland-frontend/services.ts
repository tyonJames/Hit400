...
// =============================================================================
//
// PURPOSE: One typed function per API endpoint. Services import from api/client
//          and return strongly-typed responses matching src/types/index.ts.
//
// USAGE IN COMPONENTS:
//   import { authService, propertyService } from '@/lib/api/services';
//   const properties = await propertyService.list({ page: 1, limit: 20 });
// =============================================================================
...
export const propertyService = {
  /** Register a new property — multipart/form-data with titleDeedFile */
  ...
  /** Get property by UUID — includes on-chain enrichment */
...
// =============================================================================
// VERIFICATION SERVICE (Public — no auth required)
// =============================================================================

export const verificationService = {
  /** Verify by plot number, title deed number, or owner UUID */
  verify: (params: {
