// =============================================================================
// src/components/layout/topbar.tsx — Dashboard Top Navigation Bar
// =============================================================================
//
// PURPOSE: Fixed top bar on authenticated pages. Contains:
//   - Breadcrumb / page title (derived from current path)
//   - Blockchain network indicator badge (testnet / mainnet)
//   - User avatar + dropdown menu (profile, wallet, logout)
// =============================================================================
...
// Map path segments to readable labels for breadcrumbs
  ...
  return (
    <header className="topbar">
      ...
      <div className="flex items-center gap-2">
        <h1 className="font-display text-lg text-slate-900 leading-none">
          {pageTitle}
        </h1>
      </div>

      {/* Right: network badge + user menu */}
      <div className="flex items-center gap-3">
        {/* Stacks network indicator */}
        <span className={`
