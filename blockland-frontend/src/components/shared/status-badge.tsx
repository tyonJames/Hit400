...
const STATUS_CONFIG: Record<string, BadgeConfig> = {
  ...
  PENDING_REGISTRAR_TERMS:     { label: 'Awaiting Term Review',  className: 'bg-blue-50 text-blue-700 border-blue-200',   dot: 'bg-blue-400 animate-chain-pulse' },
  AWAITING_POP:                { label: 'Awaiting Payment Proof',className: 'bg-purple-50 text-purple-700 border-purple-200', dot: 'bg-purple-400 animate-chain-pulse' },
  PENDING_SELLER_CONFIRMATION: { label: 'Awaiting Seller Confirm',className:'bg-amber-50 text-amber-700 border-amber-200', dot: 'bg-amber-400 animate-chain-pulse' },
