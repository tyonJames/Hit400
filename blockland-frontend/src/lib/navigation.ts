...
export function getPostLoginRedirect(roles: UserRole[]): string {
  ...
  if (roles.includes('USER'))      return ROUTES.PROPERTIES;
...
export const SIDEBAR_NAV: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'My Transfers',     href: ROUTES.TRANSFERS,    icon: 'Repeat', roles: ['USER'] },
      { label: 'Initiate Transfer',href: ROUTES.NEW_TRANSFER, icon: 'Send',   roles: ['USER'] },
    ],
  },
  {
    ...
    children: [
      ...
      { label: 'My Disputes',  href: ROUTES.DISPUTES,    icon: 'MessageSquareWarning', roles: ['USER'] },
      { label: 'Raise Dispute',href: ROUTES.NEW_DISPUTE, icon: 'PlusCircle',           roles: ['USER', 'REGISTRAR'] },
    ],
  },
  {
